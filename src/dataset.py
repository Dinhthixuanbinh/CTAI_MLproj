...
class MultiTaskDataset(Dataset):
    ...
    """
    def __init__(self, df_classification: pd.DataFrame, df_contrastive: pd.DataFrame, is_train: bool = True):
        """
    ...
    def __getitem__(self, idx: int) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        contrastive_row = self.df_contrastive.iloc[np.random.randint(len(self.df_contrastive))]
